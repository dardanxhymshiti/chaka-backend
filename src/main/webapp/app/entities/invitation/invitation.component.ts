...
export class InvitationComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.invitationService
      ...
      .subscribe(
        (res: HttpResponse<IInvitation[]>) => this.paginateInvitations(res.body, res.headers),
  ...
  trackId(index: number, item: IInvitation) {
    return item.id;
  }
  ...
  protected paginateInvitations(data: IInvitation[], headers: HttpHeaders) {
