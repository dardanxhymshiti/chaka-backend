...
import io.chaka.application.domain.Transaction;
import io.chaka.application.service.TransactionService;
...
/**
 * REST controller for managing {@link io.chaka.application.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
public class TransactionResource {
    ...
    public ResponseEntity<List<Transaction>> getAllTransactions(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
