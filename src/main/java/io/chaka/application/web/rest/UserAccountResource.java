...
/**
 * REST controller for managing {@link io.chaka.application.domain.UserAccount}.
 */
@RestController
@RequestMapping("/api")
public class UserAccountResource {
    ...
    public ResponseEntity<List<UserAccount>> getAllUserAccounts(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
