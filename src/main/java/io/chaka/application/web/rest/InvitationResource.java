...
/**
 * REST controller for managing {@link io.chaka.application.domain.Invitation}.
 */
@RestController
@RequestMapping("/api")
public class InvitationResource {
    ...
    public ResponseEntity<List<Invitation>> getAllInvitations(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
