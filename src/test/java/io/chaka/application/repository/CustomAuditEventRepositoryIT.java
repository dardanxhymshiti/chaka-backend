...
import io.chaka.application.config.audit.AuditEventConverter;
import io.chaka.application.domain.PersistentAuditEvent;
...
import static io.chaka.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
