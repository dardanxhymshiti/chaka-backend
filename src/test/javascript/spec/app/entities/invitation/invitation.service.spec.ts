...
describe('Service Tests', () => {
  describe('Invitation Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Invitation(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Invitation', async () => {
        const returnedFromService = Object.assign(
          {
            invitationID: 'BBBBBB',
            userID: 'BBBBBB',
      ...
      it('should return a list of Invitation', async () => {
        const returnedFromService = Object.assign(
          {
            invitationID: 'BBBBBB',
            userID: 'BBBBBB',
      ...
      it('should delete a Invitation', async () => {
